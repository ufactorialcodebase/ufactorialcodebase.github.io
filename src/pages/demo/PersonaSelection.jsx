...
const PERSONAS = [
  {
    id: 'alex',
    name: 'Alex Chen',
    bio: 'Product Manager who recently moved from SF to Phoenix with his family — balancing remote work, a growing family, and new beginnings.',
    relationships: [
      { name: 'Sarah', relationship: 'Wife', note: 'pregnant, designer at Spotify' },
      { name: 'Max', relationship: 'Son', note: '5, starting new school' },
      { name: 'Linda', relationship: 'Mom', note: 'in Phoenix, thrilled they moved' },
      { name: 'Mike', relationship: 'Best Friend', note: 'former colleague, misses him' },
    ],
    topics: ['Moving to Phoenix', 'Baby prep', 'Remote work', 'New beginnings'],
    isAvailable: true,
